CREATE TABLE IF NOT EXISTS tenants (
    ...
    created_at BIGINT NOT NULL COMMENT '创建时间，Unix 秒时间戳',
    ...
    updated_at BIGINT NOT NULL COMMENT '更新时间，Unix 秒时间戳',
...
CREATE TABLE IF NOT EXISTS platform_users (
    ...
    last_login_at BIGINT NOT NULL DEFAULT 0 COMMENT '最后登录时间，Unix 秒时间戳',
...
CREATE TABLE IF NOT EXISTS exams (
    ...
    start_time BIGINT NOT NULL COMMENT '考试开始时间，Unix 秒时间戳',
    end_time BIGINT NOT NULL COMMENT '考试结束时间，Unix 秒时间戳',
...
CREATE TABLE IF NOT EXISTS exam_attempts (
    ...
    started_at BIGINT NOT NULL COMMENT '开始作答时间，Unix 秒时间戳',
    ...
    KEY idx_exam_attempts_exam_status_submitted (tenant_id, exam_id, status, submitted_at),
    KEY idx_exam_attempts_exam_user (tenant_id, exam_id, user_id),
    KEY idx_exam_attempts_exam_id (tenant_id, exam_id, id),
    KEY idx_exam_attempts_exam_score_rank (tenant_id, exam_id, total_score, submitted_at, id)
...
CREATE TABLE IF NOT EXISTS exam_answers (
    ...
    KEY idx_exam_answers_attempt_grading (tenant_id, attempt_id, grading_status)
...
CREATE TABLE IF NOT EXISTS exam_events (
    ...
    event_time BIGINT NOT NULL COMMENT '事件发生时间，Unix 秒时间戳',
...
CREATE TABLE IF NOT EXISTS exam_operation_logs (
    ...
    operation_group_id VARCHAR(64) NOT NULL COMMENT '操作组 ID，用于多空间操作日志聚合',
    created_at BIGINT NOT NULL COMMENT '创建时间，Unix 秒时间戳',
    ...
    ext_json JSON NOT NULL COMMENT 'JSON 扩展字段，只保存展示类非核心元数据',
    PRIMARY KEY (id),
    KEY idx_exam_operation_logs_exam_time (tenant_id, exam_id, created_at, id),
    KEY idx_exam_operation_logs_exam_group (tenant_id, exam_id, operation_group_id)
