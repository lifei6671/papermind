		...
		operationLogs: []OperationLog{
			{
				...
				OperationGroupID: "invite-group-1",
			},
			{
				ID:               9002,
				TenantID:         10,
...
func TestManagementLogsKeepFullTotalAfterCrossSpaceMergePagination(t *testing.T) {
	...
	repo := &fakeRepository{
		...
		operationLogs: []OperationLog{
			{ID: 9001, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space301, CreatedAt: 1_700_000_000_500, OperationGroupID: "group-5"},
			{ID: 9002, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space302, CreatedAt: 1_700_000_000_500, OperationGroupID: "group-5"},
			{ID: 9003, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space301, CreatedAt: 1_700_000_000_400, OperationGroupID: "group-4"},
			{ID: 9004, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space302, CreatedAt: 1_700_000_000_400, OperationGroupID: "group-4"},
			{ID: 9005, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space301, CreatedAt: 1_700_000_000_300, OperationGroupID: "group-3"},
			{ID: 9006, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space302, CreatedAt: 1_700_000_000_300, OperationGroupID: "group-3"},
			{ID: 9007, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space301, CreatedAt: 1_700_000_000_200, OperationGroupID: "group-2"},
			{ID: 9008, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space302, CreatedAt: 1_700_000_000_200, OperationGroupID: "group-2"},
			{ID: 9009, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space301, CreatedAt: 1_700_000_000_100, OperationGroupID: "group-1"},
			{ID: 9010, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space302, CreatedAt: 1_700_000_000_100, OperationGroupID: "group-1"},
		},
	}
	svc := NewManagementDetailService(ManagementDetailServiceOptions{
		Repo:              repo,
...
func TestManagementLogsDeduplicateBeforePageTruncation(t *testing.T) {
	...
	repo := &fakeRepository{
		...
		operationLogs: []OperationLog{
			{ID: 9101, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space301, CreatedAt: 1_700_000_000_500, OperationGroupID: "group-5"},
			{ID: 9102, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space301, CreatedAt: 1_700_000_000_499, OperationGroupID: "group-5"},
			{ID: 9103, TenantID: 10, ExamID: 501, OperationType: OperationTypeSendInvite, OperationTitle: "重发邀请码", SpaceID: &space302, CreatedAt: 1_700_000_000_498, OperationGroupID: "group-5"},
			{ID: 9104, TenantID: 10, ExamID: 501, OperationType: OperationTypeImportCandidates, OperationTitle: "导入考生", SpaceID: &space301, CreatedAt: 1_700_000_000_400, OperationGroupID: "group-4"},
		},
	}
	svc := NewManagementDetailService(ManagementDetailServiceOptions{
		Repo:              repo,
