...
type BaseFields struct {
	...
	CreatedBy     uint64         `gorm:"column:created_by"`                     // 创建人主体 ID。
	CreatedByType string         `gorm:"column:created_by_type;default:system"` // 创建人主体类型：platform_user / tenant_user / system。
	UpdatedAt     int64          `gorm:"column:updated_at"`                     // 更新时间，Unix 毫秒时间戳。
	UpdatedBy     uint64         `gorm:"column:updated_by"`                     // 更新人主体 ID。
	UpdatedByType string         `gorm:"column:updated_by_type;default:system"` // 更新人主体类型：platform_user / tenant_user / system。
